...
public interface GetDataService {
    ...
    Call<ArrayList<Mahasiswa>> getMahasiswaAll(@Path("nim_progmob") String nim_progmob);//fungsi yg akan dipanggil di app (cara 1) hasilnya: /api/progmob/dosen/72170101
